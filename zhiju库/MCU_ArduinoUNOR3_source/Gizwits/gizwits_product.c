  ...
  for(i=0; i<info->num; i++)
  {
    switch(info->event[i])
    {
      ...
      case EVENT_led_1:
        ...
        attrFlags.flagled_1 = 1;
        break;
      case EVENT_led_2:
        currentDataPoint.valueled_2 = dataPointPtr->valueled_2;
        attrFlags.flagled_2 = 1;
        break;
      case EVENT_reshuiqi:
        currentDataPoint.valuereshuiqi = dataPointPtr->valuereshuiqi;
        attrFlags.flagreshuiqi = 1;
        break;
      case EVENT_jinghuaqi:
        currentDataPoint.valuejinghuaqi = dataPointPtr->valuejinghuaqi;
        attrFlags.flagjinghuaqi = 1;
        break;
