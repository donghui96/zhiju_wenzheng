...
* @{
*/
#define PRODUCT_KEY "6c3bc512c6914b409452b6ecaef9ebfa"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "dd048826f5ba427fbd8ac23068ebb9be"
...
#define door_BITOFFSET                     0
#define door_LEN                           1
#define chuang_BYTEOFFSET                    0
#define chuang_BITOFFSET                     1
#define chuang_LEN                           1
#define led_1_BYTEOFFSET                    0
#define led_1_BITOFFSET                     2
#define led_1_LEN                           1
#define led_2_BYTEOFFSET                    0
#define led_2_BITOFFSET                     3
#define led_2_LEN                           1
#define reshuiqi_BYTEOFFSET                    0
#define reshuiqi_BITOFFSET                     4
#define reshuiqi_LEN                           1
#define jinghuaqi_BYTEOFFSET                    0
#define jinghuaqi_BITOFFSET                     5
#define jinghuaqi_LEN                           1

#define tiaoguang_RATIO                         1
#define tiaoguang_ADDITION                      0
#define tiaoguang_MIN                           0
#define tiaoguang_MAX                           255
...
typedef struct {
  uint8_t flagdoor:1;
  uint8_t flagchuang:1;
  uint8_t flagled_1:1;
  uint8_t flagled_2:1;
  uint8_t flagreshuiqi:1;
  uint8_t flagjinghuaqi:1;
  uint8_t flagtiaoguang:1;
} attrFlags_t;
