...
void Gizwits::read(EVENT_TYPE_T eventType, bool* value)
{
	...
	{
	      case EVENT_door:
	        *value = currentDataPoint.valuedoor;
	        break;
	      case EVENT_chuang:
	        *value = currentDataPoint.valuechuang;
	        break;
	      case EVENT_led_1:
	        *value = currentDataPoint.valueled_1;
	        break;
	      case EVENT_led_2:
	        *value = currentDataPoint.valueled_2;
	        break;
	      case EVENT_reshuiqi:
	        *value = currentDataPoint.valuereshuiqi;
	        break;
	      case EVENT_jinghuaqi:
	        *value = currentDataPoint.valuejinghuaqi;
	        break;
		default:
			break;
	}
...
bool Gizwits::hasBeenSet(EVENT_TYPE_T eventType)
{
	...
	{
			case EVENT_door:
				flag = 	attrFlags.flagdoor;
				attrFlags.flagdoor = 0;
				break;
			case EVENT_chuang:
				...
				break;
			case EVENT_led_1:
				flag = 	attrFlags.flagled_1;
				attrFlags.flagled_1 = 0;
				break;
			case EVENT_led_2:
				flag = 	attrFlags.flagled_2;
				attrFlags.flagled_2 = 0;
				break;
			case EVENT_reshuiqi:
				flag = 	attrFlags.flagreshuiqi;
				attrFlags.flagreshuiqi = 0;
				break;
			case EVENT_jinghuaqi:
				flag = 	attrFlags.flagjinghuaqi;
				attrFlags.flagjinghuaqi = 0;
				break;
			case EVENT_tiaoguang:
